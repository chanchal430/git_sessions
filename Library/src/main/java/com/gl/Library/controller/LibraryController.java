...
import com.gl.Library.service.LibraryServiceImpl;
...
public class LibraryController {
	...
	@PostMapping("/addBook")
	public Book addBook(@RequestParam("id") int id, @RequestParam("title") String title,
			@RequestParam("author") String author, @RequestParam("cat") String cat) {
		Book b2 = new Book();
		b2.setId(id);
		b2.setTitle(title);
		b2.setAuthor(author);
...
//	}
	...
	public Book updateBook(@RequestParam("bookid") int bid, @RequestBody Book b3) {
	...
	public String showFormForUpdate(@RequestParam("bookId") int bid,Model theModel ) {
